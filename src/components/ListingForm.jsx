...
// import { FaHome, FaDollarSign, FaMapMarkerAlt, FaCity, FaBed, FaBath, FaImage, FaTimes } from "react-icons/fa";
...
//          <button type="submit" className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition">Create Listing</button>
