...
//     { name: 'Blocked Users', value: users.filter(user => user.status === 'blocked').length }, // Add blocked users
//   ];
...
//     { id: '1', name: 'maintenanceMode', value: 'false', description: 'Enable maintenance mode' },
//     { id: '2', name: 'userRegistration', value: 'true', description: 'Allow new user registrations' },
//     { id: '3', name: 'listingAutoApproval', value: 'false', description: 'Auto-approve new listings' },
//     { id: '4', name: 'maxFileSize', value: '5', description: 'Maximum file upload size (MB)' },
//   ]);
